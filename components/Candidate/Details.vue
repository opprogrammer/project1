<script setup>
	...
	const { currCandidate: currRecord } = useCandidate();
				...
				<div class="flex items-center gap-4">
					...
					<div>
						...
						<p class="text-sm text-slate-500 mb-2 max-lg:text-xs">
							{{ currRecord?.workstream }} - {{ currRecord?.job_title }}
						</p>
					</div>
				</div>
							...
							<div class="flex gap-2 mt-4 border-b border-b-slate-200 pb-4">
								...
								<div>
									...
									<p class="text-xs text-gray-600 font-medium">
										Employee Successfully Interviewed for this stage
									</p>
