<template>
    <tr>
      <td>
        ...
        <input
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-11/12 p-2.5 "
          type="text"  name="agencyname" :value="editFormData.agencyname" @input="handleEditFormChange" />
      </td>
      <td>
        <input
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-11/12 p-2.5 "
          type="text"  name="agencynumber" :value="editFormData.agencynumber" @input="handleEditFormChange" />
      </td>

      <td>
        <input
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-11/12 p-2.5 "
          type="text"  name="agencystatus" :value="editFormData.agencystatus" @input="handleEditFormChange" />
      </td>
      ...
      <td class="text-center">
        <div class="flex ml-3 items-center">
          ...
          <button type="button" @click="handleCancelClick">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
              class="w-[26px] h-[26px] text-red-600">
